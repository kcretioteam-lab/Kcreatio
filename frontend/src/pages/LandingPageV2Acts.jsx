/**
 * LandingPageV2Acts — Section components for LandingPageV2 (served at /v2)
 * Copy of LandingPageActs.jsx with the V2 copy edits + InvoiceShowcase.
 */
...
export function TaxRiskCalculator() {
  ...
  async function handleEstimate(e) {
    ...
    try {
      ...
      setError("Couldn't calculate right now. Check your connection and try again.");
    } finally {
      setLoading(false);
    }
  }
